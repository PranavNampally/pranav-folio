    ...
    <div className="mx-4 my-16 flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-12 items-start">
        <div className="flex flex-col gap-2">
          <h1 className="m-0 text-whitishText text-4xl font-semibold">
            Hi, I'm Pranav
          </h1>
          <p className="m-0 text-grayishText text-base">
        ...
        <div className="flex flex-col gap-2 text-base text-grayishText">
          ...
          <div className="flex gap-4 items-center ">
            <div className="relative p-2">
              ...
              <div className="bg-activeGreen w-2 h-2 rounded-[50%] absolute left-2"></div>
            </div>
